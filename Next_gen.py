...
# ----------------------------------------
    ...
    if player_name:
        ...
        df_skills['name'] = df_skills['name'].str.strip().str.lower()

        if player_name not in df_skills['name'].values:
            st.warning(f"El jugador '{player_name}' no se encuentra en el dataset.")
        else:
            try:
                ...
                # Después, filtrar según el pie preferido
